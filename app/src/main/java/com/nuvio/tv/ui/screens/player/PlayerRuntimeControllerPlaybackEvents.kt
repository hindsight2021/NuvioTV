        ...
        PlayerEvent.OnPlayPause -> {
            if (isUsingMpvEngine()) {
                ...
                if (playing) {
                    ...
                    schedulePauseOverlay()
                    com.nuvio.tv.core.sound.AudioFeedbackManager.playPlaybackAction(context, com.nuvio.tv.core.sound.PlaybackSoundAction.PAUSE)
                } else {
                    ...
                    emitScrobbleStart()
                    com.nuvio.tv.core.sound.AudioFeedbackManager.playPlaybackAction(context, com.nuvio.tv.core.sound.PlaybackSoundAction.PLAY)
                }
            } else {
                _exoPlayer?.let { player ->
                    if (player.isPlaying) {
